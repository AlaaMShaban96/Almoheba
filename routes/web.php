...
Route::get('/teams',[WebsiteController::class,'member'])->name('member');
Route::get('/about',[WebsiteController::class,'about'])->name('about');
Route::get('/login',[WebsiteController::class,'login'])->name('login');
Route::post('/login',[LoginController::class,'login']);
Route::post('/send', [WebsiteController::class,'send']);
...
Route::group(['middleware' => ['auth']], function () {
    ...
    // Route::group(['prefix' => 'Dashboard'], function () {
        ...
        Route::post('/Dashboard/setting',[SettingController::class,'store'])->name('setting');
        // Route::post('/Dashboard/setting/{setting}/edit',[SettingController::class,'update'])->name('setting');
        Route::delete('/Dashboard/setting',[SettingController::class,'destroy'])->name('setting');
