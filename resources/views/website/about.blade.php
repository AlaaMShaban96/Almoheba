    ...
    <main>
      <section class="about u-margin-top-bottom container--row">
        <div class="about__text">
          <h2 class="secondary-heading">يوجد نص هنا</h2>
          <p class="paragraph">
            يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص
            هنايوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد
            نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا
            يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص
            هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد
            نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا
          </p>
          <p class="paragraph">
            يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص هنا يوجد نص
        ...
        <div class="about__img">
          <img src="img/about-construction.png" alt="" />
        </div>
      </section>
    </main>
      ...
      <div class="footer__content container--row">
        ...
        <div class="social-media">
          <a href="#" class="social-media__link">
            <img
              src="img/logo/facebook-circle.svg"
              alt=""
          ...
          <a href="#" class="social-media__link">
            <img
              src="img/logo/linkedin-circle.svg"
              alt=""
              class="social-media__icon"
            />
          </a>
